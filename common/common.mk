...
INIT += init.qcom.set_dpi.sh
INIT += init.qcom.sd_hot_plug.sh
...
INIT += init.qcom.dsds_persist.sh
INIT += init.qcom.rootagent.sh
...
ifeq ($(strip $(QRDExt_TraditionalChinese)),yes)
        PRODUCT_LOCALES := $(PRODUCT_LOCALES) zh_TW
endif
